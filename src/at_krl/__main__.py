...
parser.add_argument('-a', '--allen', required=False, help='[NOT REQUIRED] Input or output file path to convert from or to XML temporal (Allen) objects: events and intervals definitions')
